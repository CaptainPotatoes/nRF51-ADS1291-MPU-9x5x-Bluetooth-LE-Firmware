...
#define PERIPHERAL_LINK_COUNT            1                                          /**< Number of peripheral links used by the application. When changing this number remember to adjust the RAM settings*/
			/**@DEVICE INFO*/
#define DEVICE_NAME                      "ECGSensor"                      	    /**< Name of device. Will be included in the advertising data. */
...
#define DEVICE_FIRMWARE_STRING					 "Version 1.2"
...
#define APP_TIMER_OP_QUEUE_SIZE          4                                          /**< Size of timer operation queues. */
			/**@GAP INITIALIZATION:*/
#define MIN_CONN_INTERVAL                MSEC_TO_UNITS(30, UNIT_1_25_MS)//40        /**< Minimum acceptable connection interval (0.1 seconds). */
#define MAX_CONN_INTERVAL                MSEC_TO_UNITS(32, UNIT_1_25_MS)//40        /**< Maximum acceptable connection interval (0.2 second). */
...
#define TIMER_INTERVAL_UPDATE    		 		APP_TIMER_TICKS(40, APP_TIMER_PRESCALER)//25Hz*10dataPoints
